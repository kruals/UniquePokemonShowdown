import { As, StatusName, ID, SideID, MoveTarget, GenderName, TypeName, HPColor, StatsTable, Player, GameType, GenerationNum, BoostID, Weather, FieldCondition, SideCondition } from '@pkmn/types';
...
declare namespace Request {
    type SideInfo = Protocol.Request.SideInfo;
...
declare namespace Protocol {
    ...
    interface BattleMinorArgs {
         ...
         * `EFFECT`.
         */
        '|-ability|': readonly ['-ability', PokemonIdent, AbilityName] | readonly ['-ability', PokemonIdent, AbilityName, AbilityName | Side | PokemonIdent | 'boost'] | readonly ['-ability', PokemonIdent, AbilityName, AbilityName, PokemonIdent];
        /**
         * `|-endability|POKEMON`
         *
